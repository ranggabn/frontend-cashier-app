...
export default function DetailPembelian() {
  ...
  useEffect(() => {
    if (router.isReady) {
      ...
      getDetailPembelian(nomor_struk);
    }
  }, [router.isReady]);

  const getDetailPembelian = (nomor_struk) => {
    axios
      .get(api + "getDetailPembelian", {
        params: {
      ...
      <Row>
        <Col className="col-title">
          <Container>
            <Row>
              <Col>
                <h1 className="page-title">Laporan Detail Pembelian</h1>
              </Col>
            </Row>
            <Row>
              <Col>
                <p className="page-title">
                  Halaman ini menampilkan laporan detail pembelian.
                </p>
              </Col>
            </Row>
          </Container>
...
DetailPembelian.getLayout = function getLayout(page) {
